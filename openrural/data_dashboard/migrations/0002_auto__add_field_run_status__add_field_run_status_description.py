...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('data_dashboard_run', 'status', self.gf('django.db.models.fields.CharField')(default='initialized', max_length=32), keep_default=False)

        # Adding field 'Run.status_description'
        db.add_column('data_dashboard_run', 'status_description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Run.status'
        db.delete_column('data_dashboard_run', 'status')

        # Deleting field 'Run.status_description'
        db.delete_column('data_dashboard_run', 'status_description')
