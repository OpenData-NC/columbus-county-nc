...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Geocode.status'
        db.add_column('data_dashboard_geocode', 'status', self.gf('django.db.models.fields.CharField')(default='unneeded', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Geocode.status'
        db.delete_column('data_dashboard_geocode', 'status')
    ...
    models = {
        'data_dashboard.geocode': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'unneeded'", 'max_length': '32'}),
            'success': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'zipcode': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '16', 'blank': 'True'})
        },
        'data_dashboard.run': {
