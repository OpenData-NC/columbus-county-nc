...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Run.comment'
        db.add_column('data_dashboard_run', 'comment',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Run.comment'
        db.delete_column('data_dashboard_run', 'comment')
    ...
    models = {
        ...
        'db.schema': {
            ...
            'min_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(1970, 1, 1, 0, 0)'}),
