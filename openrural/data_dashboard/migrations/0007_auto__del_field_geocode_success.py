...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Geocode.success'
        db.delete_column('data_dashboard_geocode', 'success')


    def backwards(self, orm):
        
        # Adding field 'Geocode.success'
        db.add_column('data_dashboard_geocode', 'success', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
